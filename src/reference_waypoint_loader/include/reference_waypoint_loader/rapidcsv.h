...
struct SeparatorParams
{
     ...
     */
    explicit SeparatorParams(const char pSeparator = ',', const bool pTrim = false, const bool pHasCR = sPlatformHasCR,
...
class Document
{
     ...
     *                                handled.
     */
    explicit Document(const std::string& pPath = std::string(), const LabelParams& pLabelParams = LabelParams(),
     ...
     *                                handled.
     */
    explicit Document(std::istream& pStream, const LabelParams& pLabelParams = LabelParams(),
                      const SeparatorParams& pSeparatorParams = SeparatorParams(),
                      const ConverterParams& pConverterParams = ConverterParams())
                      ...
                      const std::string& pColumnName = std::string())
    {
        ...
        while (column.size() > GetDataRowCount())
        {
            ...
            const size_t columnCount =
                std::max(static_cast<size_t>(mLabelParams.mColumnNameIdx + 1), GetDataColumnCount());
