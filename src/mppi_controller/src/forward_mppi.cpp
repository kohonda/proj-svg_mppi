...
namespace mppi
{
    namespace cpu
    {
        ...
        std::pair<ControlSeq, double> ForwardMPPI::solve(const State &initial_state)
        {
            ...
            prior_samples_ptr_->noised_control_seq_samples_ = transport_samples(*prior_samples_ptr_, func_calc_costs,
        ...
        void ForwardMPPI::set_obstacle_map(const grid_map::GridMap &obstacle_map)
        {
            mpc_base_ptr_->set_obstacle_map(obstacle_map);
        };

        void ForwardMPPI::set_reference_map(const grid_map::GridMap &reference_map)
        {
        ...
        std::tuple<StateSeq, double, double, double> ForwardMPPI::get_predictive_seq(const State &initial_state, const ControlSeq &control_input_seq) const
        {
        ...
        ControlSeq ForwardMPPI::get_control_seq() const
        {
            return prev_control_seq_;
        }

        std::pair<StateSeq, XYCovMatrices> ForwardMPPI::get_proposed_state_distribution() const
        {
        ...
        ControlSeq ForwardMPPI::grad_reverse_kld(const ControlSeq &mean_seq, const ControlSeq &noised_seq, const ControlSeqCovMatrices &inv_covs,
        ...
        ControlSeqBatch ForwardMPPI::grad_reverse_kld_batch(const PriorSamplesWithCosts &samples, const std::function<std::vector<double>(const PriorSamplesWithCosts &)> &calc_costs) const
        {
...
#pragma omp parallel for num_threads(thread_num_)
        ...
        ControlSeqBatch ForwardMPPI::transport_samples(const PriorSamplesWithCosts &samples_with_cost, const std::function<std::vector<double>(const PriorSamplesWithCosts &)> &calc_costs,
                                                       const int &num_itr, const double &step_size)
        {
...
#pragma omp parallel for num_threads(thread_num_)
        ...
        ControlSeqBatch ForwardMPPI::transport_samples(const PriorSamplesWithCosts &samples, const ControlSeqBatch &grad_kld_batch, const int &num_itr, const double &step_size) const
        {
