...
namespace local_costmap_generator
{
  ...
  private:
     ...
     */
    void preprocess_pointcloud(const pcl::PointCloud<PointType>::ConstPtr &in_pcl_ptr_,
                               pcl::PointCloud<PointType>::Ptr &out_pcl_ptr_);
     ...
     */
    std::vector<grid_map::Index> pointcloud_to_costmap(const pcl::PointCloud<PointType>::ConstPtr &in_pcl_ptr,
                                                       grid_map::GridMap *out_cost_map) const;
